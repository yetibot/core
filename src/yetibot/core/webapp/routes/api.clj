...
;; todo - bind *adapter* from hash instaed of all this messaging-fns crazyness
(comment

  ;; TODO: move *target* to chat. and maybe chat-source too?
  ;; ok awesome, i can get rid of this nasty binding junk. right?
...
(defroutes api-routes
  #_(GET "/api" [& params :as req] (api params req))
  #_(POST "/api" [& params :as req] (api params req)))
